// api/src/controllers/emotionController.ts
 ...
 * POST /api/emotions
 */
export async function saveEmotion(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function getEmotionSummary(req: Request, res: Response): Promise<void> {
  try {
    const { childId } = req.params;
